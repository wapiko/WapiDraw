...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/WapiDraw1.0.0/ && $(COPY_FILE) --parents wapidraw.h .tmp/WapiDraw1.0.0/ && $(COPY_FILE) --parents main.cpp wapidraw.cpp .tmp/WapiDraw1.0.0/ && $(COPY_FILE) --parents wapidraw.ui .tmp/WapiDraw1.0.0/ && (cd `dirname .tmp/WapiDraw1.0.0` && $(TAR) WapiDraw1.0.0.tar WapiDraw1.0.0 && $(COMPRESS) WapiDraw1.0.0.tar) && $(MOVE) `dirname .tmp/WapiDraw1.0.0`/WapiDraw1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/WapiDraw1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_wapidraw.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_wapidraw.cpp
moc_wapidraw.cpp: ../../qt/5.3/gcc/include/QtWidgets/QMainWindow \
